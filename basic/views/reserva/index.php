...
<div class="reserva-index">
    ...
    <p>
        ...
        <?= Html::a('Ver unión Reserva-Pista', ['reserva-pista/index'], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Ver unión Reserva-Material', ['reserva-material/index'], ['class' => 'btn btn-primary']) ?>
    </p>
